...
public class KitchenGameMultiplayer : NetworkBehaviour
{
    ...
    {
        bool isApproved = KitchenGameManager.Instance.IsWaitingToStart();

        connectionApprovalResponse.Approved = isApproved;
        connectionApprovalResponse.CreatePlayerObject = isApproved;
    }
